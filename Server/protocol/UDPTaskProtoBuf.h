#ifndef _UDPTaskProtoBuf__H__
#define _UDPTaskProtoBuf__H__
#include "aDef.h"
#include "aUDPTask.h"
#include "ProtoFun.h"
#include "aRWLock.h"
...
class UDPTaskProtoBuf : public aUDPTask
{
	public:
		UDPTaskProtoBuf(const int sock, const struct sockaddr_in *addr ,DWORD connectID ,const bool checkSignal = true) : aUDPTask(sock,addr,connectID,checkSignal)
		{
			init();
		}
		/**
