...
typedef void(* f_idea_encrypt)(unsigned long *d, IDEA_KEY_SCHEDULE *ks);
...
class Stream;
bool MD5Data(const void *pData,int szie,unsigned char * pMD5 /*16Byte*/);
bool MD5File(const char * pszFile, unsigned char * pMD5 /*16Byte*/);
bool MD5String(const char * string, unsigned char * pMD5 /*16Byte*/);
...
extern void DES_encrypt3(DES_LONG * data,DES_key_schedule * ks1,DES_key_schedule * ks2,DES_key_schedule * ks3,t_DES_SPtrans * sp);
extern void DES_decrypt3(DES_LONG * data,DES_key_schedule * ks1,DES_key_schedule * ks2,DES_key_schedule * ks3,t_DES_SPtrans * sp);
...
extern void idea_encrypt(unsigned long *d, IDEA_KEY_SCHEDULE *ks);

extern void CAST_set_key(CAST_KEY *key, int len, unsigned char *data);
...
public:
	...
	void set_key_rc5(const unsigned char * data, int nLen,int rouunds);
...
private:
	...
	void idea_encrypt(unsigned long *d, IDEA_KEY_SCHEDULE *ks);
