...
void DES_encrypt3(DES_LONG * data,DES_key_schedule * ks1,DES_key_schedule * ks2,DES_key_schedule * ks3,t_DES_SPtrans * sp)
{
...
void DES_random_key(DES_cblock * ret)
{
	do 
	{
		for(unsigned int i = 0; i<sizeof(DES_cblock);++i)
			(*ret)[i] = (unsigned int)(256.0*rand()/(RAND_MAX+1.0));
